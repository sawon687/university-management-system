...
router.patch('/me',auth("STUDENT"),validationReq.validate(studentValidation.studentProfileValidationSchema),studentController.updateme)
router.get('/me',auth('STUDENT'),studentController.getStudentProfile)
router.post('/application-admission',auth("STUDENT"),validationReq.validate(studentValidation.admissionBodySchema),studentController.admissionApplication)
...
router.post('/student-enrolement',auth('STUDENT'),validationReq.validate(studentValidation.studentEnrollmentValidationSchema),studentController.studentEnrolement)
